...
{
    public class TransactionCategoriesController : PaceBaseController
    {
        private readonly IRepositoryX<TransactionCategory> _repo;
        private readonly IUnitOfWork _uow;

        public TransactionCategoriesController(IRepositoryX<TransactionCategory> repo, IUnitOfWork uow)
        {
            _repo = repo;
            _uow = uow;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<TransactionCategory>> Post([FromBody] TransactionCategory item)
        {
            item.UserId = UserId;
            _repo.Insert(item);
